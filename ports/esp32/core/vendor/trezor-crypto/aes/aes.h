...
AES_RETURN aes_encrypt_(const unsigned char *in, unsigned char *out, const aes_encrypt_ctx cx[1]);
...
AES_RETURN aes_decrypt_(const unsigned char *in, unsigned char *out, const aes_decrypt_ctx cx[1]);
