...
AES_RETURN aes_xi(encrypt_)(const unsigned char *in, unsigned char *out, const aes_encrypt_ctx cx[1])
...
AES_RETURN aes_xi(decrypt_)(const unsigned char *in, unsigned char *out, const aes_decrypt_ctx cx[1])
{   uint32_t        locals(b0, b1);
