...
static IRAM_ATTR void derivation_function(const uint8_t *input1, size_t input1_length,
...
static IRAM_ATTR void chacha_drbg_update(CHACHA_DRBG_CTX *ctx,
...
IRAM_ATTR void chacha_drbg_generate(CHACHA_DRBG_CTX *ctx, uint8_t *output,
...
IRAM_ATTR void chacha_drbg_reseed(CHACHA_DRBG_CTX *ctx, const uint8_t *entropy,
